...
class GCodeExecutor(GCodeCommands):
	...
	def calculate_bed_rotation_matrice(self):
		...
		T = self.robot.make_affine_object(0.0, 0.0, 0.0, a=0.0, b=-self.angle_between(bed_normal_vec_x,robot_normal_vec), c=self.angle_between(bed_normal_vec_y,robot_normal_vec))
		self.T_robot_bed = T
